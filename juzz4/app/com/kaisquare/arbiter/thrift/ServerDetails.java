...
public class ServerDetails implements org.apache.thrift.TBase<ServerDetails, ServerDetails._Fields>, java.io.Serializable, Cloneable {
  ...
  private int cpuUsage; // required
  private int memUsage; // required
  private int availDiskSpace; // required
  private int totalDiskSpace; // required
  private int activeStreams; // required
  private int maxStreams; // required
