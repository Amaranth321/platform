...
public class DeviceServerService {
  ...
  public interface Iface {
     ...
     * @param ttl
     */
    public boolean keepAlive(long deviceId, long channelMask, int ttl) throws org.apache.thrift.TException;
     ...
     * @param streamProfile
     */
    public boolean updateDeviceStreamProfile(long deviceId, int channel, String streamType, String streamProfile) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void keepAlive(long deviceId, long channelMask, int ttl, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.keepAlive_call> resultHandler) throws org.apache.thrift.TException;
    ...
    public void updateDeviceStreamProfile(long deviceId, int channel, String streamType, String streamProfile, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.updateDeviceStreamProfile_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean keepAlive(long deviceId, long channelMask, int ttl) throws org.apache.thrift.TException
    {
      send_keepAlive(deviceId, channelMask, ttl);
      return recv_keepAlive();
    }

    public void send_keepAlive(long deviceId, long channelMask, int ttl) throws org.apache.thrift.TException
    {
      keepAlive_args args = new keepAlive_args();
      args.setDeviceId(deviceId);
      args.setChannelMask(channelMask);
      args.setTtl(ttl);
    ...
    public boolean updateDeviceStreamProfile(long deviceId, int channel, String streamType, String streamProfile) throws org.apache.thrift.TException
    {
      send_updateDeviceStreamProfile(deviceId, channel, streamType, streamProfile);
      return recv_updateDeviceStreamProfile();
    }

    public void send_updateDeviceStreamProfile(long deviceId, int channel, String streamType, String streamProfile) throws org.apache.thrift.TException
    {
      updateDeviceStreamProfile_args args = new updateDeviceStreamProfile_args();
      args.setDeviceId(deviceId);
      args.setChannel(channel);
      args.setStreamType(streamType);
      args.setStreamProfile(streamProfile);
      sendBase("updateDeviceStreamProfile", args);
    }

    public boolean recv_updateDeviceStreamProfile() throws org.apache.thrift.TException
    {
      updateDeviceStreamProfile_result result = new updateDeviceStreamProfile_result();
      receiveBase(result, "updateDeviceStreamProfile");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "updateDeviceStreamProfile failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void keepAlive(long deviceId, long channelMask, int ttl, org.apache.thrift.async.AsyncMethodCallback<keepAlive_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      keepAlive_call method_call = new keepAlive_call(deviceId, channelMask, ttl, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void updateDeviceStreamProfile(long deviceId, int channel, String streamType, String streamProfile, org.apache.thrift.async.AsyncMethodCallback<updateDeviceStreamProfile_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      updateDeviceStreamProfile_call method_call = new updateDeviceStreamProfile_call(deviceId, channel, streamType, streamProfile, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class updateDeviceStreamProfile_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long deviceId;
      private int channel;
      private String streamType;
      private String streamProfile;
      public updateDeviceStreamProfile_call(long deviceId, int channel, String streamType, String streamProfile, org.apache.thrift.async.AsyncMethodCallback<updateDeviceStreamProfile_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.deviceId = deviceId;
        this.channel = channel;
        this.streamType = streamType;
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("updateDeviceStreamProfile", org.apache.thrift.protocol.TMessageType.CALL, 0));
        updateDeviceStreamProfile_args args = new updateDeviceStreamProfile_args();
        args.setDeviceId(deviceId);
        args.setChannel(channel);
        args.setStreamType(streamType);
      ...
      public boolean getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_updateDeviceStreamProfile();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("updateDeviceStreamProfile", new updateDeviceStreamProfile());
    ...
    private static class keepAlive<I extends Iface> extends org.apache.thrift.ProcessFunction<I, keepAlive_args> {
      ...
      protected keepAlive_result getResult(I iface, keepAlive_args args) throws org.apache.thrift.TException {
        keepAlive_result result = new keepAlive_result();
        result.success = iface.keepAlive(args.deviceId, args.channelMask, args.ttl);
        result.setSuccessIsSet(true);
        return result;
      }
    }
    ...
    private static class updateDeviceStreamProfile<I extends Iface> extends org.apache.thrift.ProcessFunction<I, updateDeviceStreamProfile_args> {
      public updateDeviceStreamProfile() {
        super("updateDeviceStreamProfile");
      }

      protected updateDeviceStreamProfile_args getEmptyArgsInstance() {
        return new updateDeviceStreamProfile_args();
      }

      protected updateDeviceStreamProfile_result getResult(I iface, updateDeviceStreamProfile_args args) throws org.apache.thrift.TException {
        updateDeviceStreamProfile_result result = new updateDeviceStreamProfile_result();
        result.success = iface.updateDeviceStreamProfile(args.deviceId, args.channel, args.streamType, args.streamProfile);
        result.setSuccessIsSet(true);
        return result;
      }
    }
...
;
  ...
  public static class setConfiguration_args implements org.apache.thrift.TBase<setConfiguration_args, setConfiguration_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private String configurations; // required
  ...
  public static class getConfiguration_args implements org.apache.thrift.TBase<getConfiguration_args, getConfiguration_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private String option; // required
  ...
  public static class addDevice_args implements org.apache.thrift.TBase<addDevice_args, addDevice_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private String deviceKey; // required
    private List<String> supportedTaskTypes; // required
    private String deviceInfo; // required
...
;
  ...
  public static class keepAlive_args implements org.apache.thrift.TBase<keepAlive_args, keepAlive_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField DEVICE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("deviceId", org.apache.thrift.protocol.TType.I64, (short)1);
    private static final org.apache.thrift.protocol.TField CHANNEL_MASK_FIELD_DESC = new org.apache.thrift.protocol.TField("channelMask", org.apache.thrift.protocol.TType.I64, (short)2);
    ...
    private long deviceId; // required
    private long channelMask; // required
    private int ttl; // required
    ...
    // isset id assignments
    private static final int __DEVICEID_ISSET_ID = 0;
    private static final int __CHANNELMASK_ISSET_ID = 1;
    ...
    public keepAlive_args setChannelMask(long channelMask) {
      this.channelMask = channelMask;
      setChannelMaskIsSet(true);
      return this;
    }
    ...
    public Object getFieldValue(_Fields field) {
      ...
      case CHANNEL_MASK:
        return Long.valueOf(getChannelMask());
    ...
    private static class keepAlive_argsStandardScheme extends StandardScheme<keepAlive_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, keepAlive_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // CHANNEL_MASK
              if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
                struct.channelMask = iprot.readI64();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, keepAlive_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeI64(struct.channelMask);
        oprot.writeFieldEnd();
  ...
  public static class startTask_args implements org.apache.thrift.TBase<startTask_args, startTask_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private String taskType; // required
    private String taskInfo; // required
  ...
  public static class getDeviceStreamProfile_args implements org.apache.thrift.TBase<getDeviceStreamProfile_args, getDeviceStreamProfile_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private long deviceId; // required
    private int channel; // required
    private String streamType; // required
  ...
  public static class updateDeviceStreamProfile_args implements org.apache.thrift.TBase<updateDeviceStreamProfile_args, updateDeviceStreamProfile_args._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("updateDeviceStreamProfile_args");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new updateDeviceStreamProfile_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new updateDeviceStreamProfile_argsTupleSchemeFactory());
    }

    private long deviceId; // required
    private int channel; // required
    private String streamType; // required
    private String streamProfile; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.STREAM_PROFILE, new org.apache.thrift.meta_data.FieldMetaData("streamProfile", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(updateDeviceStreamProfile_args.class, metaDataMap);
    }

    public updateDeviceStreamProfile_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public updateDeviceStreamProfile_args(updateDeviceStreamProfile_args other) {
      __isset_bit_vector.clear();
      __isset_bit_vector.or(other.__isset_bit_vector);
      this.deviceId = other.deviceId;
      this.channel = other.channel;
    ...
    public updateDeviceStreamProfile_args deepCopy() {
      return new updateDeviceStreamProfile_args(this);
    }
    ...
    public updateDeviceStreamProfile_args setDeviceId(long deviceId) {
      this.deviceId = deviceId;
      setDeviceIdIsSet(true);
      return this;
    }
    ...
    public updateDeviceStreamProfile_args setChannel(int channel) {
      this.channel = channel;
      setChannelIsSet(true);
      return this;
    }
    ...
    public updateDeviceStreamProfile_args setStreamType(String streamType) {
      this.streamType = streamType;
      return this;
    }
    ...
    public updateDeviceStreamProfile_args setStreamProfile(String streamProfile) {
      this.streamProfile = streamProfile;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof updateDeviceStreamProfile_args)
        return this.equals((updateDeviceStreamProfile_args)that);
      return false;
    }

    public boolean equals(updateDeviceStreamProfile_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(updateDeviceStreamProfile_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      updateDeviceStreamProfile_args typedOther = (updateDeviceStreamProfile_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("updateDeviceStreamProfile_args(");
      boolean first = true;
    ...
    private static class updateDeviceStreamProfile_argsStandardSchemeFactory implements SchemeFactory {
      public updateDeviceStreamProfile_argsStandardScheme getScheme() {
        return new updateDeviceStreamProfile_argsStandardScheme();
      }
    }

    private static class updateDeviceStreamProfile_argsStandardScheme extends StandardScheme<updateDeviceStreamProfile_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, updateDeviceStreamProfile_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateDeviceStreamProfile_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class updateDeviceStreamProfile_argsTupleSchemeFactory implements SchemeFactory {
      public updateDeviceStreamProfile_argsTupleScheme getScheme() {
        return new updateDeviceStreamProfile_argsTupleScheme();
      }
    }

    private static class updateDeviceStreamProfile_argsTupleScheme extends TupleScheme<updateDeviceStreamProfile_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, updateDeviceStreamProfile_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetDeviceId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, updateDeviceStreamProfile_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(4);
        if (incoming.get(0)) {
          struct.deviceId = iprot.readI64();
  ...
  public static class updateDeviceStreamProfile_result implements org.apache.thrift.TBase<updateDeviceStreamProfile_result, updateDeviceStreamProfile_result._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("updateDeviceStreamProfile_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.BOOL, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new updateDeviceStreamProfile_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new updateDeviceStreamProfile_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(updateDeviceStreamProfile_result.class, metaDataMap);
    }

    public updateDeviceStreamProfile_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public updateDeviceStreamProfile_result(updateDeviceStreamProfile_result other) {
      __isset_bit_vector.clear();
      __isset_bit_vector.or(other.__isset_bit_vector);
      this.success = other.success;
    }

    public updateDeviceStreamProfile_result deepCopy() {
      return new updateDeviceStreamProfile_result(this);
    }
    ...
    public updateDeviceStreamProfile_result setSuccess(boolean success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof updateDeviceStreamProfile_result)
        return this.equals((updateDeviceStreamProfile_result)that);
      return false;
    }

    public boolean equals(updateDeviceStreamProfile_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(updateDeviceStreamProfile_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      updateDeviceStreamProfile_result typedOther = (updateDeviceStreamProfile_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("updateDeviceStreamProfile_result(");
      boolean first = true;
    ...
    private static class updateDeviceStreamProfile_resultStandardSchemeFactory implements SchemeFactory {
      public updateDeviceStreamProfile_resultStandardScheme getScheme() {
        return new updateDeviceStreamProfile_resultStandardScheme();
      }
    }

    private static class updateDeviceStreamProfile_resultStandardScheme extends StandardScheme<updateDeviceStreamProfile_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, updateDeviceStreamProfile_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateDeviceStreamProfile_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class updateDeviceStreamProfile_resultTupleSchemeFactory implements SchemeFactory {
      public updateDeviceStreamProfile_resultTupleScheme getScheme() {
        return new updateDeviceStreamProfile_resultTupleScheme();
      }
    }

    private static class updateDeviceStreamProfile_resultTupleScheme extends TupleScheme<updateDeviceStreamProfile_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, updateDeviceStreamProfile_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, updateDeviceStreamProfile_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readBool();
...
;
  ...
  public static class setDeviceSnapshot_args implements org.apache.thrift.TBase<setDeviceSnapshot_args, setDeviceSnapshot_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private long deviceId; // required
    private int channel; // required
    private ByteBuffer snapshot; // required
