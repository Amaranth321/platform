...
public class DeviceDetails implements org.apache.thrift.TBase<DeviceDetails, DeviceDetails._Fields>, java.io.Serializable, Cloneable {
  ...
  private String lat; // required
  private String lng; // required
  private String accountId; // required
  private String modelId; // required
  private String statusId; // required
  private String functionalityId; // required
  private String alertFlag; // required
  private String alive; // required
  private String currentPositionId; // required
  private String action; // required
  private String eventSettings; // required
  private String deviceServerUrls; // required
  private String liveview; // required
  private String snapshotRecordingEnabled; // required
  private String snapshotRecordingInterval; // required
  private String cloudRecordingEnabled; // required
