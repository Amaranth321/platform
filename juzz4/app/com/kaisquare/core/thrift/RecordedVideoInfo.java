 ...
 * (3) from - The timestamp when video was started (ddMMyyyyHHmmss format)
 * (4) to - The timestamp when video was stoped (ddMMyyyyHHmmss format)
 */
public class RecordedVideoInfo implements org.apache.thrift.TBase<RecordedVideoInfo, RecordedVideoInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RecordedVideoInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new RecordedVideoInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RecordedVideoInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RecordedVideoInfo.class, metaDataMap);
  }
   ...
   */
  public RecordedVideoInfo(RecordedVideoInfo other) {
  ...
  public RecordedVideoInfo deepCopy() {
    return new RecordedVideoInfo(this);
  }
  ...
  public RecordedVideoInfo setDeviceId(String deviceId) {
    this.deviceId = deviceId;
    return this;
  }
  ...
  public RecordedVideoInfo setChannelId(String channelId) {
    this.channelId = channelId;
    return this;
  }
  ...
  public RecordedVideoInfo setFrom(String from) {
    this.from = from;
    return this;
  }
  ...
  public RecordedVideoInfo setTo(String to) {
    this.to = to;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RecordedVideoInfo)
      return this.equals((RecordedVideoInfo)that);
    return false;
  }

  public boolean equals(RecordedVideoInfo that) {
    if (that == null)
      return false;
  ...
  public int compareTo(RecordedVideoInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    RecordedVideoInfo typedOther = (RecordedVideoInfo)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RecordedVideoInfo(");
    boolean first = true;
  ...
  private static class RecordedVideoInfoStandardSchemeFactory implements SchemeFactory {
    public RecordedVideoInfoStandardScheme getScheme() {
      return new RecordedVideoInfoStandardScheme();
    }
  }

  private static class RecordedVideoInfoStandardScheme extends StandardScheme<RecordedVideoInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RecordedVideoInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RecordedVideoInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RecordedVideoInfoTupleSchemeFactory implements SchemeFactory {
    public RecordedVideoInfoTupleScheme getScheme() {
      return new RecordedVideoInfoTupleScheme();
    }
  }

  private static class RecordedVideoInfoTupleScheme extends TupleScheme<RecordedVideoInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RecordedVideoInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RecordedVideoInfo struct) throws org.apache.thrift.TException {
