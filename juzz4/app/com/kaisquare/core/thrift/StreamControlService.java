...
public class StreamControlService {
  ...
  public interface Iface {
     ...
     * @param fileTime
     */
    public boolean cancelStreamForPlayback(String deviceId, String channelId, String mediaType, List<String> fileTime) throws CoreException, org.apache.thrift.TException;
     ...
     * @param endTimestamp
     */
    public List<com.kaisquare.core.thrift.StreamFileDetails> getStreamFileDetails(String sessionId, String deviceId, String channelId, String mediaType, String startTimestamp, String endTimestamp) throws CoreException, org.apache.thrift.TException;
     ...
     * @param channel
     */
    public boolean resetMediaFiles(long deviceId, int channel) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void cancelStreamForPlayback(String deviceId, String channelId, String mediaType, List<String> fileTime, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.cancelStreamForPlayback_call> resultHandler) throws org.apache.thrift.TException;

    public void getStreamFileDetails(String sessionId, String deviceId, String channelId, String mediaType, String startTimestamp, String endTimestamp, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.getStreamFileDetails_call> resultHandler) throws org.apache.thrift.TException;

    public void resetMediaFiles(long deviceId, int channel, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.resetMediaFiles_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean cancelStreamForPlayback(String deviceId, String channelId, String mediaType, List<String> fileTime) throws CoreException, org.apache.thrift.TException
    {
      send_cancelStreamForPlayback(deviceId, channelId, mediaType, fileTime);
      return recv_cancelStreamForPlayback();
    }

    public void send_cancelStreamForPlayback(String deviceId, String channelId, String mediaType, List<String> fileTime) throws org.apache.thrift.TException
    {
    ...
    public List<com.kaisquare.core.thrift.StreamFileDetails> getStreamFileDetails(String sessionId, String deviceId, String channelId, String mediaType, String startTimestamp, String endTimestamp) throws CoreException, org.apache.thrift.TException
    {
      send_getStreamFileDetails(sessionId, deviceId, channelId, mediaType, startTimestamp, endTimestamp);
      return recv_getStreamFileDetails();
    }

    public void send_getStreamFileDetails(String sessionId, String deviceId, String channelId, String mediaType, String startTimestamp, String endTimestamp) throws org.apache.thrift.TException
    {
    ...
    public boolean resetMediaFiles(long deviceId, int channel) throws org.apache.thrift.TException
    {
      send_resetMediaFiles(deviceId, channel);
      return recv_resetMediaFiles();
    }

    public void send_resetMediaFiles(long deviceId, int channel) throws org.apache.thrift.TException
    {
      resetMediaFiles_args args = new resetMediaFiles_args();
      args.setDeviceId(deviceId);
      args.setChannel(channel);
      sendBase("resetMediaFiles", args);
    }

    public boolean recv_resetMediaFiles() throws org.apache.thrift.TException
    {
      resetMediaFiles_result result = new resetMediaFiles_result();
      receiveBase(result, "resetMediaFiles");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "resetMediaFiles failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void cancelStreamForPlayback(String deviceId, String channelId, String mediaType, List<String> fileTime, org.apache.thrift.async.AsyncMethodCallback<cancelStreamForPlayback_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      cancelStreamForPlayback_call method_call = new cancelStreamForPlayback_call(deviceId, channelId, mediaType, fileTime, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class cancelStreamForPlayback_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public cancelStreamForPlayback_call(String deviceId, String channelId, String mediaType, List<String> fileTime, org.apache.thrift.async.AsyncMethodCallback<cancelStreamForPlayback_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.deviceId = deviceId;
        this.channelId = channelId;
        this.mediaType = mediaType;
    ...
    public void getStreamFileDetails(String sessionId, String deviceId, String channelId, String mediaType, String startTimestamp, String endTimestamp, org.apache.thrift.async.AsyncMethodCallback<getStreamFileDetails_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getStreamFileDetails_call method_call = new getStreamFileDetails_call(sessionId, deviceId, channelId, mediaType, startTimestamp, endTimestamp, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void resetMediaFiles(long deviceId, int channel, org.apache.thrift.async.AsyncMethodCallback<resetMediaFiles_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      resetMediaFiles_call method_call = new resetMediaFiles_call(deviceId, channel, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class resetMediaFiles_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long deviceId;
      private int channel;
      public resetMediaFiles_call(long deviceId, int channel, org.apache.thrift.async.AsyncMethodCallback<resetMediaFiles_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.deviceId = deviceId;
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("resetMediaFiles", org.apache.thrift.protocol.TMessageType.CALL, 0));
        resetMediaFiles_args args = new resetMediaFiles_args();
        args.setDeviceId(deviceId);
        args.setChannel(channel);
        args.write(prot);
      ...
      public boolean getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_resetMediaFiles();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("resetMediaFiles", new resetMediaFiles());
      return processMap;
    }
    ...
    private static class cancelStreamForPlayback<I extends Iface> extends org.apache.thrift.ProcessFunction<I, cancelStreamForPlayback_args> {
      ...
      protected cancelStreamForPlayback_result getResult(I iface, cancelStreamForPlayback_args args) throws org.apache.thrift.TException {
        cancelStreamForPlayback_result result = new cancelStreamForPlayback_result();
        try {
          result.success = iface.cancelStreamForPlayback(args.deviceId, args.channelId, args.mediaType, args.fileTime);
          result.setSuccessIsSet(true);
        } catch (CoreException coreExp) {
          result.coreExp = coreExp;
        }
    ...
    private static class getStreamFileDetails<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getStreamFileDetails_args> {
      ...
      protected getStreamFileDetails_result getResult(I iface, getStreamFileDetails_args args) throws org.apache.thrift.TException {
        getStreamFileDetails_result result = new getStreamFileDetails_result();
        try {
          result.success = iface.getStreamFileDetails(args.sessionId, args.deviceId, args.channelId, args.mediaType, args.startTimestamp, args.endTimestamp);
        } catch (CoreException coreExp) {
          result.coreExp = coreExp;
        }
        return result;
    ...
    private static class resetMediaFiles<I extends Iface> extends org.apache.thrift.ProcessFunction<I, resetMediaFiles_args> {
      public resetMediaFiles() {
        super("resetMediaFiles");
      }

      protected resetMediaFiles_args getEmptyArgsInstance() {
        return new resetMediaFiles_args();
      }

      protected resetMediaFiles_result getResult(I iface, resetMediaFiles_args args) throws org.apache.thrift.TException {
        resetMediaFiles_result result = new resetMediaFiles_result();
        result.success = iface.resetMediaFiles(args.deviceId, args.channel);
        result.setSuccessIsSet(true);
        return result;
      }
    }
  ...
  public static class beginStreamSession_args implements org.apache.thrift.TBase<beginStreamSession_args, beginStreamSession_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private List<String> allowedClientIpAddresses; // required
  ...
  public static class beginStreamSession_result implements org.apache.thrift.TBase<beginStreamSession_result, beginStreamSession_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private CoreException coreExp; // required
...
;
  ...
  public static class getActiveOutboundStreamList_result implements org.apache.thrift.TBase<getActiveOutboundStreamList_result, getActiveOutboundStreamList_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private List<com.kaisquare.core.thrift.StreamInfo> success; // required
    private CoreException coreExp; // required
  ...
  public static class getRecordedMediaList_args implements org.apache.thrift.TBase<getRecordedMediaList_args, getRecordedMediaList_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private String deviceId; // required
    private String channelId; // required
    private String mediaType; // required
    private String startTimestamp; // required
    private String endTimestamp; // required
  ...
  public static class getRecordedMediaList_result implements org.apache.thrift.TBase<getRecordedMediaList_result, getRecordedMediaList_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private List<RecordedMediaInfo> success; // required
    private CoreException coreExp; // required
...
;
  ...
  public static class getStorageStatus_result implements org.apache.thrift.TBase<getStorageStatus_result, getStorageStatus_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private List<com.kaisquare.core.thrift.StorageInfo> success; // required
    private CoreException coreExp; // required
  ...
  public static class cancelStreamForPlayback_args implements org.apache.thrift.TBase<cancelStreamForPlayback_args, cancelStreamForPlayback_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private String channelId; // required
    private String mediaType; // required
    private List<String> fileTime; // required
  ...
  public static class getStreamFileDetails_result implements org.apache.thrift.TBase<getStreamFileDetails_result, getStreamFileDetails_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private List<com.kaisquare.core.thrift.StreamFileDetails> success; // required
    private CoreException coreExp; // required
  ...
  public static class resetMediaFiles_args implements org.apache.thrift.TBase<resetMediaFiles_args, resetMediaFiles_args._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("resetMediaFiles_args");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new resetMediaFiles_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new resetMediaFiles_argsTupleSchemeFactory());
    }

    private long deviceId; // required
    private int channel; // required
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(resetMediaFiles_args.class, metaDataMap);
    }

    public resetMediaFiles_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public resetMediaFiles_args(resetMediaFiles_args other) {
      __isset_bit_vector.clear();
      __isset_bit_vector.or(other.__isset_bit_vector);
      this.deviceId = other.deviceId;
    ...
    public resetMediaFiles_args deepCopy() {
      return new resetMediaFiles_args(this);
    }
    ...
    public resetMediaFiles_args setDeviceId(long deviceId) {
      this.deviceId = deviceId;
      setDeviceIdIsSet(true);
      return this;
    }
    ...
    public resetMediaFiles_args setChannel(int channel) {
      this.channel = channel;
      setChannelIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof resetMediaFiles_args)
        return this.equals((resetMediaFiles_args)that);
      return false;
    }

    public boolean equals(resetMediaFiles_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(resetMediaFiles_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      resetMediaFiles_args typedOther = (resetMediaFiles_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("resetMediaFiles_args(");
      boolean first = true;
    ...
    private static class resetMediaFiles_argsStandardSchemeFactory implements SchemeFactory {
      public resetMediaFiles_argsStandardScheme getScheme() {
        return new resetMediaFiles_argsStandardScheme();
      }
    }

    private static class resetMediaFiles_argsStandardScheme extends StandardScheme<resetMediaFiles_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, resetMediaFiles_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, resetMediaFiles_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class resetMediaFiles_argsTupleSchemeFactory implements SchemeFactory {
      public resetMediaFiles_argsTupleScheme getScheme() {
        return new resetMediaFiles_argsTupleScheme();
      }
    }

    private static class resetMediaFiles_argsTupleScheme extends TupleScheme<resetMediaFiles_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, resetMediaFiles_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetDeviceId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, resetMediaFiles_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.deviceId = iprot.readI64();
  ...
  public static class resetMediaFiles_result implements org.apache.thrift.TBase<resetMediaFiles_result, resetMediaFiles_result._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("resetMediaFiles_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.BOOL, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new resetMediaFiles_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new resetMediaFiles_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(resetMediaFiles_result.class, metaDataMap);
    }

    public resetMediaFiles_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public resetMediaFiles_result(resetMediaFiles_result other) {
      __isset_bit_vector.clear();
      __isset_bit_vector.or(other.__isset_bit_vector);
      this.success = other.success;
    }

    public resetMediaFiles_result deepCopy() {
      return new resetMediaFiles_result(this);
    }
    ...
    public resetMediaFiles_result setSuccess(boolean success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof resetMediaFiles_result)
        return this.equals((resetMediaFiles_result)that);
      return false;
    }

    public boolean equals(resetMediaFiles_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(resetMediaFiles_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      resetMediaFiles_result typedOther = (resetMediaFiles_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("resetMediaFiles_result(");
      boolean first = true;
    ...
    private static class resetMediaFiles_resultStandardSchemeFactory implements SchemeFactory {
      public resetMediaFiles_resultStandardScheme getScheme() {
        return new resetMediaFiles_resultStandardScheme();
      }
    }

    private static class resetMediaFiles_resultStandardScheme extends StandardScheme<resetMediaFiles_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, resetMediaFiles_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, resetMediaFiles_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class resetMediaFiles_resultTupleSchemeFactory implements SchemeFactory {
      public resetMediaFiles_resultTupleScheme getScheme() {
        return new resetMediaFiles_resultTupleScheme();
      }
    }

    private static class resetMediaFiles_resultTupleScheme extends TupleScheme<resetMediaFiles_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, resetMediaFiles_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, resetMediaFiles_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readBool();
