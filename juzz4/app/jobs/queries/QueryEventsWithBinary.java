 ...
 * @since v4.4
 */
public class QueryEventsWithBinary extends Job<ServerPagedResult<EventWithBinary>>
{
    private final Model.MorphiaQuery query = EventWithBinary.q();
     ...
     */
    public QueryEventsWithBinary(List<EventType> eventTypes,
    ...
    @Override
    public ServerPagedResult<EventWithBinary> doJobWithResult()
    {
