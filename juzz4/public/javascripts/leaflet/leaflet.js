...
(function (t, e, i) {
    ...
    typeof exports != i + "" ? n = exports : (o = t.L, n = {}, n.noConflict = function () {
        return t.L = o, this
    }, t.L = n), n.version = "0.6-dev", n.Util = {extend: function (t) {
        ...
        var a = this;
        return e.__super__ = a.prototype, o.callInitHooks = function () {
    ...
    n.Mixin = {}, n.Mixin.Events = {addEventListener: function (t, e, i) {
        var o, a, r, h, l, u, c, _, p = this[s] = this[s] || {};
        if ("object" == typeof t) {
            for (o in t)t.hasOwnProperty(o) && this.addEventListener(o, t[o], e);
            return this
        }
        for (t = n.Util.splitWords(t), a = 0, r = t.length; r > a; a++)h = {action: e, context: i || this}, l = i && i._leaflet_id, l ? (u = t[a] + "_idx", c = u + "_len", _ = p[u] = p[u] || {}, _[l] ? _[l].push(h) : (_[l] = [h], p[c] = (p[c] || 0) + 1)) : (p[t[a]] = p[t[a]] || [], p[t[a]].push(h));
        return this
    }, hasEventListeners: function (t) {
        return s in this && (t in this[s] && this[s][t].length > 0 || this[s][t + "_idx_len"] > 0)
    }, removeEventListener: function (t, e, i) {
        var o, a, r, h, l, u, c, _, p = this[s];
        if ("object" == typeof t) {
            for (o in t)t.hasOwnProperty(o) && this.removeEventListener(o, t[o], e);
            return this
        }
        for (t = n.Util.splitWords(t), a = 0, r = t.length; r > a; a++)if (this.hasEventListeners(t[a])) {
            for (u = i && i._leaflet_id, c = t[a] + "_idx", h = u && p[c] ? p[c][u] || [] : p[t[a]] || [], l = h.length - 1; l >= 0; l--)e && h[l].action !== e || i && h[l].context !== i || h.splice(l, 1);
            u && 0 === h.length && (_ = c + "_len", delete p[c][u], p[_] = (p[_] || 1) - 1)
        }
        return this
    }, fireEvent: function (t, e) {
        if (!this.hasEventListeners(t))return this;
        var i, o, a, r, h, l = n.Util.extend({type: t, target: this}, e);
        if (this[s][t])for (i = this[s][t].slice(), o = 0, a = i.length; a > o; o++)i[o].action.call(i[o].context || this, l);
        if (r = this[s][t + "_idx"])for (h in r)if (r.hasOwnProperty(h) && (i = r[h]))for (o = 0, a = i.length; a > o; o++)i[o].action.call(i[o].context || this, l);
        return this
        ...
        n.Browser = {ie: o, ie6: s, ie7: a, ielt9: r, webkit: l, android: c, android23: _, chrome: u, ie3d: g, webkit3d: v, gecko3d: y, opera3d: P, any3d: L, mobile: p, mobileWebkit: p && l, mobileWebkit3d: p && v, mobileOpera: p && t.opera, touch: w, msTouch: d, retina: m}
    ...
    }}, n.point = function (t, e, o) {
        return t instanceof n.Point ? t : n.Util.isArray(t) ? new n.Point(t[0], t[1]) : t === i || null === t ? t : new n.Point(t, e, o)
        ...
        var i, o = 0, s = 0, a = t, r = e.body, h = e.documentElement, l = n.Browser.ie7;
        do {
            ...
            if ("fixed" === i) {
                o += r.scrollTop || h.scrollTop || 0, s += r.scrollLeft || h.scrollLeft || 0;
                break
            }
            a = a.offsetParent
        } while (a);
        ...
        do {
            if (a === r)break;
            o -= a.scrollTop || 0, s -= a.scrollLeft || 0, n.DomUtil.documentIsLtr() || !n.Browser.webkit && !l || (s += a.scrollWidth - a.clientWidth, l && "hidden" !== n.DomUtil.getStyle(a, "overflow-y") && "hidden" !== n.DomUtil.getStyle(a, "overflow") && (s += 17)), a = a.parentNode
        } while (a);
        ...
        return t instanceof n.LatLng ? t : n.Util.isArray(t) ? new n.LatLng(t[0], t[1]) : t === i || null === t ? t : "object" == typeof t && "lat"in t ? new n.LatLng(t.lat, "lng"in t ? t.lng : t.lon) : new n.LatLng(t, e)
        ...
        return(0 !== i.x || 0 !== i.y) && (t === !0 ? this.panBy(i) : (this._rawPanBy(i), this.fire("move"), clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(n.bind(this.fire, this, "moveend"), 200))), this
    }, addHandler: function (t, e) {
        return e ? (this[t] = new e(this), this.options[t] && this[t].enable(), this) : i
    }, remove: function () {
        return this._initEvents("off"), delete this._container._leaflet, this
    }, getCenter: function () {
        ...
        var s = this._zoom !== e;
        o || (this.fire("movestart"), s && this.fire("zoomstart")), this._zoom = e, this._initialCenter = t, this._initialTopLeftPoint = this._getNewTopLeftPoint(t), i ? this._initialTopLeftPoint._add(this._getMapPanePos()) : n.DomUtil.setPosition(this._mapPane, new n.Point(0, 0)), this._tileLayersToLoad = this._tileLayersNum;
        var a = !this._loaded;
        ...
        if (n.DomEvent) {
            e = e || "on", n.DomEvent[e](this._container, "click", this._onMouseClick, this);
            var i, o, s = ["dblclick", "mousedown", "mouseup", "mouseenter", "mouseleave", "mousemove", "contextmenu"];
            for (i = 0, o = s.length; o > i; i++)n.DomEvent[e](this._container, s[i], this._fireMouseEvent, this);
            this.options.trackResize && n.DomEvent[e](t, "resize", this._onResize, this)
        }
    }, _onResize: function () {
        ...
        return t && !t.equals(new n.Point(0, 0))
        ...
        for (var e, i = n.LatLng.RAD_TO_DEG, o = this.R_MAJOR, s = this.R_MINOR, a = t.x * i / o, r = s / o, h = Math.sqrt(1 - r * r), l = Math.exp(-t.y / s), u = Math.PI / 2 - 2 * Math.atan(l), c = 15, _ = 1e-7, p = c, d = .1; Math.abs(d) > _ && --p > 0;)e = h * Math.sin(u), d = Math.PI / 2 - 2 * Math.atan(l * Math.pow((1 - e) / (1 + e), .5 * h)) - u, u += d;
        ...
        this._map = t, this._animated = t.options.zoomAnimation && n.Browser.any3d, this._initContainer(), this._createTileProto(), t.on({viewreset: this._reset, moveend: this._update}, this), this._animated && t.on({zoomanim: this._animateZoom, zoomend: this._endZoomAnim}, this), this.options.updateWhenIdle || (this._limitedUpdate = n.Util.limitExecByInterval(this._update, 150, this), t.on("move", this._limitedUpdate, this)), this._reset(), this._update()
    }, addTo: function (t) {
        ...
        var t, e = this._tiles;
        if (n.Browser.ielt9)for (t in e)e.hasOwnProperty(t) && n.DomUtil.setOpacity(e[t], this.options.opacity); else n.DomUtil.setOpacity(this._container, this.options.opacity);
        if (n.Browser.webkit)for (t in e)e.hasOwnProperty(t) && (e[t].style.webkitTransform += " translate(0,0)")
    }, _initContainer: function () {
        var t = this._map._panes.tilePane;
        if (!this._container) {
            if (this._container = n.DomUtil.create("div", "leaflet-layer"), this._updateZIndex(), this._animated) {
                var e = "leaflet-tile-container leaflet-zoom-animated";
                this._bgBuffer = n.DomUtil.create("div", e, this._container), this._tileContainer = n.DomUtil.create("div", e, this._container)
        ...
        var e = this._tiles[t];
        this.fire("tileunload", {tile: e, url: e.src}), this.options.reuseTiles ? (n.DomUtil.removeClass(e, "leaflet-tile-loaded"), this._unusedTiles.push(e)) : e.parentNode === this._tileContainer && this._tileContainer.removeChild(e), n.Browser.android || (e.src = n.Util.emptyImageUrl), delete this._tiles[t]
    }, _addTile: function (t, e) {
        var i = this._getTilePos(t), o = this._getTile();
        n.DomUtil.setPosition(o, i, n.Browser.chrome || n.Browser.android23), this._tiles[t.x + ":" + t.y] = o, this._loadTile(o, t), o.parentNode !== this._tileContainer && e.appendChild(o)
        ...
        return n.Util.template(this._url, n.extend({s: this._getSubdomain(t), z: t.z, x: t.x, y: t.y}, this.options))
        ...
        return t.onselectstart = t.onmousemove = n.Util.falseFn, n.Browser.ielt9 && this.options.opacity !== i && n.DomUtil.setOpacity(t, this.options.opacity), t
        ...
        this._tilesToLoad--, this._tilesToLoad || (this.fire("load"), this._animated && (clearTimeout(this._clearBgBufferTimer), this._clearBgBufferTimer = setTimeout(n.bind(this._clearBgBuffer, this), 500)))
        ...
        this._url = t;
        var i = n.extend({}, this.defaultWmsParams), o = e.tileSize || this.options.tileSize;
        i.width = i.height = e.detectRetina && n.Browser.retina ? 2 * o : o;
        ...
        return i = i.add(n.Popup.prototype.options.offset), e && e.offset && (i = i.add(e.offset)), e = n.extend({offset: i}, e), this._popup || this.on("click", this.openPopup, this).on("remove", this.closePopup, this).on("move", this._movePopup, this), t instanceof n.Popup ? (n.setOptions(t, e), this._popup = t) : this._popup = new n.Popup(e, this).setContent(t), this
        ...
        return t instanceof n.Popup ? this._popup = t : ((!this._popup || e) && (this._popup = new n.Popup(e, this)), this._popup.setContent(t)), this._popupHandlersAdded || (this.on("click", this._openPopup, this).on("remove", this.closePopup, this), this._popupHandlersAdded = !0), this
    }, unbindPopup: function () {
        ...
        for (i = 0, o = t.length; o > i; i++) {
            if (n.Util.isArray(t[i]) && "number" != typeof t[i][0])return;
            s[i] = n.latLng(t[i])
        }
        return s
    }, _initEvents: function () {
        ...
        var i, o, s, a, r, h, l, u, c, _ = [1, 4, 2, 8], p = n.LineUtil;
        for (o = 0, l = t.length; l > o; o++)t[o]._code = p._getBitCode(t[o], e);
        for (a = 0; 4 > a; a++) {
            for (u = _[a], i = [], o = 0, l = t.length, s = l - 1; l > o; s = o++)r = t[o], h = t[s], r._code & u ? h._code & u || (c = p._getEdgeIntersection(h, r, u, e), c._code = p._getBitCode(c, e), i.push(c)) : (h._code & u && (c = p._getEdgeIntersection(h, r, u, e), c._code = p._getBitCode(c, e), i.push(c)), i.push(r));
            t = i
        }
        return t
    }, n.Polygon = n.Polyline.extend({options: {fill: !0}, initialize: function (t, e) {
        n.Polyline.prototype.initialize.call(this, t, e), t && n.Util.isArray(t[0]) && "number" != typeof t[0][0] && (this._latlngs = this._convertLatLngs(t[0]), this._holes = t.slice(1)), t = this._latlngs, t[0].equals(t[t.length - 1]) && t.pop()
    }, projectLatlngs: function () {
        ...
        }, t.addEventListener(h, a, !1)) : "click" === e && n.Browser.android ? (r = a, a = function (t) {
            return n.DomEvent._filterClick(t, r)
        ...
        var o = n.DomEvent._lastClick && t.timeStamp - n.DomEvent._lastClick;
        return o && o > 100 && 400 > o ? (n.DomEvent.stop(t), i) : (n.DomEvent._lastClick = t.timeStamp, e(t))
        ...
        if (!t.shiftKey && (1 === t.which || 1 === t.button || t.touches) && (n.DomEvent.preventDefault(t), n.DomEvent.stopPropagation(t), !n.Draggable._disabled)) {
        ...
        if (t.fire("dragend"), o)t.fire("moveend"); else {
            var s = this._lastPos.subtract(this._positions[0]), a = (this._lastTime + i - this._times[0]) / 1e3, r = e.easeLinearity, h = s.multiplyBy(r / a), l = h.distanceTo(new n.Point(0, 0)), u = Math.min(e.inertiaMaxSpeed, l), c = h.multiplyBy(u / l), _ = u / (e.inertiaDeceleration * r), p = c.multiplyBy(-_ / 2).round();
            n.Util.requestAnimFrame(function () {
                t.panBy(p, _, r, !0)
            })
        }
        e.maxBounds && n.Util.requestAnimFrame(this._panInsideMaxBounds, t, !0, t._container)
        ...
        function s(t) {
            var e;
            if (n.Browser.msTouch ? (d.push(t.pointerId), e = d.length) : e = t.touches.length, !(e > 1)) {
        ...
        var r, h, l = !1, u = 250, c = "_leaflet_", _ = this._touchstart, p = this._touchend, d = [];
        t[c + _ + o] = s, t[c + p + o] = a;
        var m = n.Browser.msTouch ? e.documentElement : t;
        return t.addEventListener(_, s, !1), m.addEventListener(p, a, !1), n.Browser.msTouch && m.addEventListener("MSPointerCancel", a, !1), this
        ...
        if (this._moved && this._zooming) {
            ...
            var i = this._getScaleOrigin(), o = t.layerPointToLatLng(i), s = t.getZoom(), a = t.getScaleZoom(this._scale) - s, r = a > 0 ? Math.ceil(a) : Math.floor(a), h = t._limitZoom(s + r), l = t.getZoomScale(h) / this._scale;
            t._animateZoom(o, h, i, l, null, !0)
        }
        ...
        this._pane.removeChild(this._box), this._container.style.cursor = "", n.DomUtil.enableTextSelection(), n.DomEvent.off(e, "mousemove", this._onMouseMove).off(e, "mouseup", this._onMouseUp).off(e, "keydown", this._onKeyDown)
    }, _onMouseUp: function (t) {
        this._finish();
        var e = this._map, i = e.mouseEventToLayerPoint(t);
        if (!this._startLayerPoint.equals(i)) {
            var o = new n.LatLngBounds(e.layerPointToLatLng(this._startLayerPoint), e.layerPointToLatLng(i));
        ...
        var e = "leaflet-control-zoom", i = n.DomUtil.create("div", e + " leaflet-bar");
    ...
    }, n.Control.Attribution = n.Control.extend({options: {position: "bottomright", prefix: '<a href="http://kaisquare.com" title="KAI Square Cloud-based surveillance"></a>'}, initialize: function (t) {
        ...
        return t ? (this._attributions[t] && (this._attributions[t]--, this._update()), this) : i
    }, _update: function () {
        if (this._map) {
            var t = [];
        ...
        for (this._handlingClick = !0, t = 0; s > t; t++)e = o[t], i = this._layers[e.layerId], e.checked && !this._map.hasLayer(i.layer) ? (this._map.addLayer(i.layer), i.overlay ? this._map.fire("overlayadd", {layer: i}) : n = i.layer) : !e.checked && this._map.hasLayer(i.layer) && (this._map.removeLayer(i.layer), this._map.fire("overlayremove", {layer: i}));
        ...
        e = this._limitZoom(e), t = n.latLng(t);
        var o = this._zoom !== e;
        if (this._loaded && !i && this._layers) {
            this._panAnim && this._panAnim.stop();
            var s = o ? this._zoomToIfClose && this._zoomToIfClose(t, e) : this._panByIfClose(t);
            if (s)return clearTimeout(this._sizeTimer), this
        }
        return this._resetView(t, e), this
    }, panBy: function (t, e, i, o) {
        if (t = n.point(t), !t.x && !t.y)return this;
        this._panAnim || (this._panAnim = new n.PosAnimation, this._panAnim.on({step: this._onPanTransitionStep, end: this._onPanTransitionEnd}, this)), o !== !0 && this.fire("movestart"), n.DomUtil.addClass(this._mapPane, "leaflet-pan-anim");
        var s = n.DomUtil.getPosition(this._mapPane).subtract(t)._round();
        ...
        var i = this.getZoomScale(e), n = this._getCenterOffset(t)._divideBy(1 - 1 / i);
        if (!this._offsetIsWithinView(n, 1))return!1;
        this.fire("movestart").fire("zoomstart");
        var o = this._getCenterLayerPoint().add(n);
        return this._animateZoom(t, e, o, i), !0
    }, _animateZoom: function (t, e, i, o, s, a) {
        n.DomUtil.addClass(this._mapPane, "leaflet-zoom-anim"), this._animateToCenter = t, this._animateToZoom = e, this._animatingZoom = !0, n.Draggable && (n.Draggable._disabled = !0), this.fire("zoomanim", {center: t, zoom: e, origin: i, scale: o, delta: s, backwards: a})
    }, _catchTransitionEnd: function () {
        this._animatingZoom && this._onZoomTransitionEnd()
    }, _onZoomTransitionEnd: function () {
        n.DomUtil.removeClass(this._mapPane, "leaflet-zoom-anim"), this._animatingZoom = !1, this._resetView(this._animateToCenter, this._animateToZoom, !0, !0), n.Draggable && (n.Draggable._disabled = !1)
    }} : {}), n.TileLayer.include({_animateZoom: function (t) {
        var e = !1;
        this._animating || (this._animating = !0, e = !0), e && this._prepareBgBuffer();
        var i = n.DomUtil.TRANSFORM, o = this._bgBuffer;
        e && (clearTimeout(this._clearBgBufferTimer), n.Util.falseFn(o.offsetWidth));
        var s = n.DomUtil.getScaleString(t.scale, t.origin), a = o.style[i];
        o.style[i] = t.backwards ? (t.delta ? n.DomUtil.getTranslateString(t.delta) : a) + " " + s : s + " " + a
    }, _endZoomAnim: function () {
        var t = this._tileContainer, e = this._bgBuffer;
        t.style.visibility = "", t.style.zIndex = 2, e.style.zIndex = 1, n.Util.falseFn(e.offsetWidth), this._animating = !1
    }, _clearBgBuffer: function () {
        var t = this._map;
        t._animatingZoom || t.touchZoom._zooming || (this._bgBuffer.innerHTML = "", this._bgBuffer.style[n.DomUtil.TRANSFORM] = "")
    }, _prepareBgBuffer: function () {
        var t = this._tileContainer, e = this._bgBuffer;
        return e && this._getLoadedTilesPercentage(e) > .5 && .5 > this._getLoadedTilesPercentage(t) ? (t.style.visibility = "hidden", this._stopLoadingImages(t), i) : (e.style.visibility = "hidden", e.style[n.DomUtil.TRANSFORM] = "", this._tileContainer = e, e = this._bgBuffer = t, this._stopLoadingImages(e), i)
        ...
        var e = t.coords.latitude, i = t.coords.longitude, o = new n.LatLng(e, i), s = 180 * t.coords.accuracy / 40075017, a = s / Math.cos(n.LatLng.DEG_TO_RAD * e), r = new n.LatLng(e - s, i - a), h = new n.LatLng(e + s, i + a), l = new n.LatLngBounds(r, h), u = this._locationOptions;
        if (u.setView) {
            var c = Math.min(this.getBoundsZoom(l), u.maxZoom);
            this.setView(o, c)
        }
        var _ = n.extend({latlng: o, bounds: l}, t.coords);
