    ...
    var heatmapFactory = (function () {
        ...
        legend.prototype = {
            init: function () {
                ...
                var offsetInt = parseInt(offset) - 290;
                // left or right
                if (position.indexOf('l') > -1) {
                    positionCss += 'left:' + offsetInt + 'px;';
                } else {
                    positionCss += 'right:' + offset + 'px;';
                }

                element = document.createElement("div");
                element.style.cssText = "border-radius:5px;position:absolute;" + positionCss + "font-family:Helvetica; width:256px;z-index:10000000000; background:rgba(255,255,255,1);padding:10px;border:1px solid #C5C5C5;margin:0;";
                element.innerHTML = "<h3 style='padding:0;margin-bottom:10px;text-align:center;font-size:14px;'>" + title + "</h3>";
