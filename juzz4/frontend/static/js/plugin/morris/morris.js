...
(function() {
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.redraw = function() {
      ...
      this.text1 = this.drawEmptyDonutLabel(cx, cy - 10, this.options.labelColor, this.options.fontFamily, 15, 800);
      this.text2 = this.drawEmptyDonutLabel(cx, cy + 10, this.options.labelColor, this.options.fontFamily, 14);
    ...
    Donut.prototype.drawEmptyDonutLabel = function(xPos, yPos, color, fontFamily, fontSize, fontWeight) {
      var text;
      text = this.raphael.text(xPos, yPos, '').attr('font-family', fontFamily).attr('font-size', fontSize).attr('fill', color);
      if (fontWeight != null) {
