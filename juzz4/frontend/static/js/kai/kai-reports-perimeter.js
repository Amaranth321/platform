angular.module('kai.reports.perimeter', [
	'ui.amcharts',
]);
angular
    .module('kai.reports.perimeter')
    .factory("PerimeterService",
        function(KupOption, AmchartsTheme, UtilsService, PromiseFactory, KupApiService, ReportsService, AuthTokenFactory, $q, $timeout) {
            ...
            var data = {
                ...
                $chartForPdf: '#perimeterChartForPdf',
...
angular
    ...
    .controller('PerimeterController',
        function(
            ...
            ReportsService, PerimeterService,
            ...
            var notification = UtilsService.notification;
            var reports = ReportsService;
            var perimeterCtrl = this;

            //UI controller
            perimeterCtrl.data = PerimeterService.data;
            perimeterCtrl.fn = {
                setTab: setTab,
            ...
            function init() {
                ...
                $scope.$watch(function() {
                    ...
                    perimeterCtrl.data.uiNodata.isShow = !reportsOpt.isSuccessReport;
                }, true);
                ...
                $scope.$watch(function() {
                    ...
                    PerimeterService.setChartTheme();
                    PerimeterService.generateChart();
                }, true);
            }

            function setTab(tabName) {
                var opt = perimeterCtrl.data;
            ...
            function exportCsv(periodType) {
                ...
                PerimeterService.exportAggregatedCsvReportApi(periodType)
                    .finally(function() {
                        warningNotify.close();
                    });
            }
            ...
            function exportPdf() {
                ...
                PerimeterService.exportVcaSecurityPdfApi()
                    .finally(function() {
                        warningNotify.close();
                    });
            }
