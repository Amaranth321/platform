angular.module('kai.reports.intrusion', [
	'ui.amcharts',
]);
angular
    .module('kai.reports.intrusion')
    .factory("IntrusionService",
        function(KupOption, AmchartsTheme, UtilsService, PromiseFactory, KupApiService, ReportsService, AuthTokenFactory, $q, $timeout) {
            ...
            var data = {
                ...
                $chartForPdf: '#intrusionChartForPdf',
...
angular
    ...
    .controller('IntrusionController',
        function(
            ...
            ReportsService, IntrusionService,
            ...
            var notification = UtilsService.notification;
            var reports = ReportsService;
            var intrusionCtrl = this;

            //UI controller
            intrusionCtrl.data = IntrusionService.data;
            intrusionCtrl.fn = {
                setTab: setTab,
            ...
            function init() {
                ...
                $scope.$watch(function() {
                    ...
                    intrusionCtrl.data.uiNodata.isShow = !reportsOpt.isSuccessReport;
                }, true);
                ...
                $scope.$watch(function() {
                    ...
                    IntrusionService.generateChart();
                }, true);
            }

            function setTab(tabName) {
                var opt = intrusionCtrl.data;
            ...
            function exportCsv(periodType) {
                ...
                IntrusionService.exportAggregatedCsvReportApi(periodType)
                    .finally(function(){
                        warningNotify.close();
                    });
            }
            ...
            function exportPdf() {
                ...
                IntrusionService.exportVcaSecurityPdfApi()
                    .finally(function(){
                        warningNotify.close();
                    });
            }
