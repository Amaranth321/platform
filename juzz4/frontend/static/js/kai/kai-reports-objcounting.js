angular.module('kai.reports.objcounting', [
	'ui.amcharts',
]);
angular
    .module('kai.reports.objcounting')
    .factory("ObjcountingService",
        function(KupOption, AmchartsTheme, UtilsService, PromiseFactory, KupApiService, ReportsService, AuthTokenFactory, $q, $timeout) {
            ...
            var data = {
                ...
                //UI selector
                $chart: '#objcountingChart',
                $chartForPdf: '#objcountingChartForPdf',
...
angular
    ...
    .controller('ObjcountingController',
        function(
            ...
            ReportsService, ObjcountingService,
            ...
            var notification = UtilsService.notification;
            var reports = ReportsService;
            var objcountingCtrl = this;

            //UI controller
            objcountingCtrl.data = ObjcountingService.data;
            objcountingCtrl.fn = {
                setTab: setTab,
            ...
            function init() {
                ...
                $scope.$watch(function() {
                    ...
                    objcountingCtrl.data.uiNodata.isShow = !reportsOpt.isSuccessReport;
                }, true);
                ...
                $scope.$watch(function() {
                    ...
                    ObjcountingService.generateChart();
                }, true);
            }

            function setTab(tabName) {
                var opt = objcountingCtrl.data;
            ...
            function exportCsv(periodType) {
                ...
                ObjcountingService.exportAggregatedCsvReportApi(periodType)
                    .finally(function(){
                        warningNotify.close();
                    });
            }
            ...
            function exportPdf() {
                ...
                ObjcountingService.exportVcaSecurityPdfApi()
                    .finally(function(){
                        warningNotify.close();
                    });
            }
