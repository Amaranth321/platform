angular.module('kai.reports.videoblur', [
	'ui.amcharts',
]);
angular
    .module('kai.reports.videoblur')
    .factory("VideoblurService",
        function(KupOption, AmchartsTheme, UtilsService, PromiseFactory, KupApiService, ReportsService, AuthTokenFactory, $q, $timeout) {
            ...
            var data = {
                ...
                //UI selector
                $chart: '#videoblurChart',
                $chartForPdf: '#videoblurChartForPdf',
...
angular
    ...
    .controller('VideoblurController',
        function(
            ...
            ReportsService, VideoblurService,
            ...
            var notification = UtilsService.notification;
            var reports = ReportsService;
            var videoblurCtrl = this;

            //UI controller
            videoblurCtrl.data = VideoblurService.data;
            videoblurCtrl.fn = {
                setTab: setTab,
            ...
            function init() {
                ...
                $scope.$watch(function() {
                    ...
                    videoblurCtrl.data.uiNodata.isShow = !reportsOpt.isSuccessReport;
                }, true);
                ...
                $scope.$watch(function() {
                    ...
                    VideoblurService.generateChart();
                }, true);
            }

            function setTab(tabName) {
                var opt = videoblurCtrl.data;
            ...
            function exportCsv(periodType) {
                ...
                VideoblurService.exportAggregatedCsvReportApi(periodType)
                    .finally(function(){
                        warningNotify.close();
                    });
            }
            ...
            function exportPdf() {
                ...
                VideoblurService.exportVcaSecurityPdfApi()
                    .finally(function(){
                        warningNotify.close();
                    });
            }
